...
/* Generated from ../O.Common/jfrx.dbd */
...
epicsShareExtern reg_func pvar_func_arrInitialize, pvar_func_asSub,
    ...
    pvar_func_tsInitialize, pvar_func_register_func_readaddr,
    pvar_func_register_func_readarrays,
    pvar_func_register_func_startserver,
    pvar_func_register_func_userfilename,
    pvar_func_register_func_writeaddr;
...
int jfrx_registerRecordDeviceDriver(DBBASE *pbase)
{
    ...
    pvar_func_register_func_readaddr();
    pvar_func_register_func_readarrays();
    pvar_func_register_func_startserver();
    pvar_func_register_func_userfilename();
    pvar_func_register_func_writeaddr();
...
/* jfrx_registerRecordDeviceDriver */
static const iocshArg rrddArg0 = {"pdbbase", iocshArgPdbbase};
static const iocshArg *rrddArgs[] = {&rrddArg0};
static const iocshFuncDef rrddFuncDef =
    {"jfrx_registerRecordDeviceDriver", 1, rrddArgs};
static void rrddCallFunc(const iocshArgBuf *)
{
    jfrx_registerRecordDeviceDriver(*iocshPpdbbase);
}
